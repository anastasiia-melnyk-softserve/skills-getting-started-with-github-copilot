  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Save the current activity selection before resetting the form
        const selectedActivity = activity;
        signupForm.reset();
        // Refresh activities to show updated participant list, preserving selection
        await fetchActivities(true);
        // Restore the activity selection
  ...
  window.unregisterParticipant = async function(activityName, participantEmail) {
    ...
    try {
      ...
      if (response.ok) {
        messageDiv.textContent = result.message;
        messageDiv.className = "success";
        // Refresh activities to show updated participant list, preserving current selection
